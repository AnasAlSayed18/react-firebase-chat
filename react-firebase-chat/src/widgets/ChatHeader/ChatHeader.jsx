...
export default function ChatHeader({ user, showBack = false, onBack }) {
  return (
    <header className="ch">
      {}
      {showBack && (
  ...
  <div className="ch-avatar">
    {user?.photoURL ? (
      <img src={user.photoURL} alt={user?.name || "User"} className="ch-avatar-img" />
    ) : (
      initials(user?.name)
    )}
  </div>
  <div className="ch-info">
    <div className="ch-name">{user?.name}</div>
    <div className="ch-status">{user?.status}</div>
  </div>
</div>
